...
import com.bzn.fundamental.rpc.thrift.zookeeper.ThriftServerAddressRegister;
import com.bzn.fundamental.rpc.thrift.zookeeper.ThriftServerIpLocalNetworkResolve;
import com.bzn.fundamental.rpc.thrift.zookeeper.ThriftServerIpResolve;

/**
 * 服务端注册服务工厂
 * 
 * @author：fengli
 * @since：2016年8月11日 下午12:38:48
 * @version:
 */
public class ThriftServiceServerFactory implements InitializingBean, Closeable {
	...
	public void setThriftServerAddressRegister(
	...
	public void afterPropertiesSet() throws Exception {
		...
		if (StringUtils.isEmpty(serverIP)) {
			throw new ThriftException("canot find server ip...");
		}
