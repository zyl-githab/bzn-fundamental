 ...
 * 
 * @author：fengli
 * @since：2016年8月11日 下午12:42:10
 * @version:
 */
public class ThriftServerAddressProviderZookeeper
		implements ThriftServerAddressProvider, InitializingBean, Closeable {
	...
	private void buildPathChildrenCache(final CuratorFramework client, String path,
